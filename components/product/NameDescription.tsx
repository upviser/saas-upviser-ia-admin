...
export const NameDescription: React.FC<Props> = ({information, setInformation, shopLogin}) => {
  ...
  return (
    <Card title='Información'>
      ...
      }} className={`${descriptionAiView.view} ${descriptionAiView.opacity} transition-opacity duration-200 bg-black/30 flex fixed w-full h-full top-0 left-0 px-4 z-50`}>
