  ...
  return (
    <div className='bg-white flex flex-col gap-4 sticky top-0 w-full lg:w-1/4 h-fit p-4 rounded-xl border border-black/5 dark:bg-neutral-800 dark:border-neutral-700' style={{ boxShadow: '0px 3px 10px 3px #11111108' }}>
      ...
      <div className='flex flex-col gap-1'>
        ...
        <Link className={`flex gap-2 ${pathname === '/configuracion/dominio' ? 'bg-main text-white' : 'hover:bg-neutral-100 dark:hover:bg-neutral-700'} p-1.5 rounded-xl transition-all duration-200 text-sm`} href='/configuracion/dominio'><TbWorldWww className={`${pathname === '/configuracion/dominio' ? 'text-white' : 'text-main'} my-auto text-lg`} />Dominio</Link>
