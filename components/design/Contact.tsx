          ...
          edit !== 'Contacto'
            ? (
              <>
                ...
                <div className={`${responsive === '400px' ? 'w-full' : 'w-1/2 pl-4'} m-auto`}>
                  <div className={`flex flex-col gap-4 p-6 sm:p-8`} style={{ boxShadow: style.design === 'Sombreado' ? `0px 3px 20px 3px ${style.borderColor}` : '', borderRadius: style.form === 'Redondeadas' ? `${style.borderBlock}px` : '', color: design.info.textColor, border: style.design === 'Borde' ? `1px solid ${style.borderColor}` : '', backgroundColor: design.info.image }}>
                    {
                      index === 0
                        ? (
                          <h2
            ...
            : (
              <>  
                ...
                <div className={`p-8 flex flex-col gap-4`} style={{ borderRadius: style.form === 'Redondeadas' ? `${style.borderBlock}px` : '', boxShadow: style.design === 'Sombreado' ? `0px 3px 20px 3px ${style.borderColor}` : '', border: style.design === 'Borde' ? `1px solid ${style.borderColor}` : '', backgroundColor: design.info.image, color: design.info.textColor }}>
