          ...
          <div className='flex flex-col gap-6 w-full max-w-[1280px] mx-auto'>
            ...
            <div className='w-full flex'>
              <div className='flex gap-6 m-auto w-full flex-wrap'>
                ...
                <Config setEmail={setEmail} email={email} setDate={setDate} date={date} clientData={clientData} setClientData={setClientData} domain={domain} services={services} calls={calls} />
              </div>
            </div>
          </div>
        </div>
