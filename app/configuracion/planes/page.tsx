...
import { IClient, IPlan, IService } from "@/interfaces";
  ...
  return (
    <>
      ...
      <Popup popup={popup} setPopup={setPopup} config="a">
        ...
        <div className='p-4 lg:p-6 w-full flex flex-col gap-6 overflow-y-auto bg-bg dark:bg-neutral-900' style={{ height: 'calc(100%)' }}>
