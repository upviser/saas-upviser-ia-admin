            ...
            <div className='flex gap-6 flex-col w-full lg:w-2/3'>
              <Card title='Productos'>
                    ...
                    sell.cart.length
                      ? sell.cart.map((product, index) => (
                        <div className='flex gap-2 justify-between' key={product._id}>
                          ...
                          <p className='mt-auto mb-auto'>${NumberFormat(offer(product))}</p>
                ...
                <div className='flex gap-2 justify-between'>
                  <p>Total</p>
                  <p>${NumberFormat(sell.cart.reduce((prev, curr) => curr.quantityOffers ? prev + offer(curr) : prev + curr.price * curr.quantity, 0))}</p>
                </div>
              </Card>
              <Card title='Datos'>
                <div className='flex gap-2'>
