  ...
  return (
    <>
      ...
      <div className='flex h-full bg-white dark:bg-neutral-900'>
        ...
        {
          part === 'Popup'
            ? <Popup calls={calls} popupWeb={popupWeb} forms={forms} responsive={responsive} renderCalendar={renderCalendar} style={style} />
            : ''
        }
        {
